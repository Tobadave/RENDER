...
const Navbar = () => {
  return (
    <nav className="flex gap-6 p-4 md:h-25 z-10 items-center bg-transparent text-white text-md justify-between md:px-20 md:border md:border-gray-800">
      {/* <nav className='bg-black w-full top-0 z-0 relative' /> */}
